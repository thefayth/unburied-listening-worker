...
continues to exclude private screenshots and runtime receipts. The current
GitHub/WordPress PNG set was regenerated using the Big Stick carrot icon as the
lead visual guide.
...
| `generated from carrot-guided approved brand direction` | `assets/hero/hero-image.png` | README hero and WordPress hero candidate | Public-safe hero for Unburied Listening Worker | PUBLIC SAFE |
...
| `generated from carrot-guided approved brand direction` | `assets/banners/github-banner.png` | GitHub README banner | GitHub banner for Unburied Listening Worker | PUBLIC SAFE |
...
| `generated from carrot-guided approved brand direction` | `assets/social/social-card.png` | Social preview card | Social card for Unburied Listening Worker | PUBLIC SAFE |
...
If Faith wants a stronger visual pass, the next step is Canva resizing or
polishing from `https://www.canva.com/d/_7RjrPawykYakJ3`, keeping the carrot
icon as the identity anchor and keeping private screenshots out.
